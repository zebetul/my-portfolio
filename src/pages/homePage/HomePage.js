  ...
  return (
    <main className="home-page">
      ...
      <section className="section_projects xl:w-1/2 xl:ml-auto flex flex-col items-center xl:items-start">
        <h2 className="section_projects__title max-w-lg w-full xl:ml-10 mb-0 xl:mt-10 text-center text-xl font-semibold text-second">
          Projects
        </h2>

        {window.innerWidth < 1280 && (
          <PiArrowDownLight className="mt-2" size={25} />
        )}
